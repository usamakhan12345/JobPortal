      ...
      <div className="row">
        <div className="col-12 col-sm-12 col-md-6 col-lg-4 mb-3">
          <div className={styles.jobs}>
            <h1 className={`fs-4 fw-bold mx-3 pt-4 ${styles.jobHead}`}>Mern Stack Developer</h1>
            <h3 className={`fw-bold  mx-3  mt-3 mb-1 ${styles.jobHead}`}>Codesy Consulting</h3>
              <div className="d-flex align-items-center mt-2 mx-3 ">
                ...
                <h5 className={`fw-bold ${styles.jobHead}`}>Islamabad</h5>
              </div>
              <div className="d-flex ">
                <h1 className={`fw-bold mt-4 bg-success text-light mx-3 ${styles.salary}`}>Rs 40,000 - Rs 90,0000 a month <TiTick style={{display : "inline-block" , fontSize : 30} }/></h1>
              </div>
        ...
        <div className={styles.jobs}>
            ...
            <h3 className={`fw-bold  mx-3  mt-3 mb-1 ${styles.jobHead}`}>Codesy Consulting</h3>
              <div className="d-flex align-items-center mt-2 mx-3 ">
                <SlLocationPin style={{marginRight : 8 , fontSize : 19 , color : 'green', fontWeight : 'bold'}}/>
                <h5 className={`fw-bold ${styles.jobHead}`}>Lahore</h5>
              </div>
              <div className="d-flex ">
                <h1 className={`fw-bold mt-4 bg-success text-light mx-3 ${styles.salary}`}>Rs 40,000 - Rs 90,0000 a month <TiTick style={{display : "inline-block" , fontSize : 30} }/></h1>
              </div>
        ...
        </div> <div className="col-12 col-sm-12 col-md-6 col-lg-4 mb-3">
        <div className={styles.jobs}>
            <h1 className={`fs-4 fw-bold mx-3 pt-4 ${styles.jobHead}`}>Mern Stack Developer</h1>
            <h3 className={`fw-bold  mx-3  mt-3 mb-1 ${styles.jobHead}`}>Codesy Consulting</h3>
              <div className="d-flex align-items-center mt-2 mx-3 ">
                <SlLocationPin style={{marginRight : 8 , fontSize : 19 , color : 'green', fontWeight : 'bold'}}/>
                <h5 className={`fw-bold ${styles.jobHead}`}>Karachi</h5>
              </div>
              <div className="d-flex ">
                <h1 className={`fw-bold mt-4 bg-success text-light mx-3 ${styles.salary}`}>Rs 40,000 - Rs 90,0000 a month <TiTick style={{display : "inline-block" , fontSize : 30} }/></h1>
              </div>
